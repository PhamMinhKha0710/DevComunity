...
namespace SocialTechsy.SocialNetwork.Infrastructure.Migrations
{
    ...
    [Migration("20260317103803_CreateOAuthLoginSessionsTable")]
    partial class CreateOAuthLoginSessionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialTechsy.SocialNetwork.Domain.Entities.MessageReaction", b =>
                {
            ...
            modelBuilder.Entity("SocialTechsy.SocialNetwork.Domain.Entities.OAuthLoginSession", b =>
                {
                    b.Property<int>("OAuthLoginSessionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OAuthLoginSessionId"));
                    ...
                    b.ToTable("OAuthLoginSessions", (string)null);
                });

            modelBuilder.Entity("SocialTechsy.SocialNetwork.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SocialTechsy.SocialNetwork.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("ExternalProviderAvatar")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("SocialTechsy.SocialNetwork.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("SocialTechsy.SocialNetwork.Domain.Entities.Message", "ReplyToMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("SocialTechsy.SocialNetwork.Domain.Entities.MessageReaction", b =>
                {
                    b.HasOne("SocialTechsy.SocialNetwork.Domain.Entities.Message", "Message")
                        .WithMany("Reactions")
