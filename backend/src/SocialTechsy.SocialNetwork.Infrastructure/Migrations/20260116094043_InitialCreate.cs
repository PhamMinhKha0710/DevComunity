        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReputationPoints = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    GiteaRepoId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CloneUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DefaultBranch = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "main"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedItems_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "AnswerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SavedItems_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedItems_AnswerId",
                table: "SavedItems",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedItems_QuestionId",
                table: "SavedItems",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedItems_UserId_AnswerId",
                table: "SavedItems",
                columns: new[] { "UserId", "AnswerId" },
                filter: "[AnswerId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_SavedItems_UserId_QuestionId",
                table: "SavedItems",
