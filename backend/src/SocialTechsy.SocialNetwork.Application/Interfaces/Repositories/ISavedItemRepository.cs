...
public interface ISavedItemRepository
{
    ...
    Task<SavedItem?> FindAsync(int userId, int? questionId, int? answerId, int? postId, CancellationToken cancellationToken = default);
    Task<bool> IsSavedAsync(int userId, int? questionId, int? answerId, int? postId, CancellationToken cancellationToken = default);
    ...
    Task DeleteByPostAsync(int userId, int postId, CancellationToken cancellationToken = default);
}
